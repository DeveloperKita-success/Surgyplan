...
class OperatingRoomController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('nurse-uk.rooms.index', [
            'rooms' => $rooms,
            'query' => $query,
    ...
    public function create(): View
    {
        ...
        return view('nurse-uk.rooms.create', [
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('nurse-uk.rooms.show', $room)
    ...
    public function show(OperatingRoom $operatingRoom): View
    {
        ...
        return view('nurse-uk.rooms.show', [
    ...
    public function edit(OperatingRoom $operatingRoom): View
    {
        ...
        return view('nurse-uk.rooms.edit', [
            'room' => $operatingRoom,
            'specialists' => $this->specialists(),
            'statuses' => self::STATUSES,
        ]);
    ...
    public function update(Request $request, OperatingRoom $operatingRoom): RedirectResponse
    {
        ...
        return redirect()
            ->route('nurse-uk.rooms.show', $operatingRoom)
