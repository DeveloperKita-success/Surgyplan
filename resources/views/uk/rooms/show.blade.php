<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('uk.rooms.index') }}" class="rounded-lg border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50">Kembali</a>
            <a href="{{ route('uk.rooms.edit', $room) }}" class="rounded-lg bg-cyan-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-cyan-800">Edit Kamar</a>
        </div>
