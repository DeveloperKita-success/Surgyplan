<x-app-layout>
    ...
    @php
        ...
        $verification = $surgeryRequest->ukVerificationChecklist;
        ...
        $signatureItems = [
            ['name' => 'anesthesia_consent_signed', 'title' => 'Consent anestesi bertanda tangan', 'file' => $checklist?->anesthesia_consent_file, 'checked' => $checklist?->anesthesia_consent_signed],
        ];
    @endphp
    ...
    <div class="space-y-5">
        ...
        <div class="grid gap-5 xl:grid-cols-[1.1fr_0.95fr_0.95fr]">
            ...
            @if ($isReviewable)
                <form id="verification-form" method="POST" action="{{ route('nurse-uk.requests.decide', $surgeryRequest) }}" class="xl:col-span-2">
                    @csrf
                        ...
                        <section class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                            ...
                            <div class="flex items-center justify-between gap-3 rounded-lg border border-emerald-100 bg-emerald-50 px-3 py-2 text-sm">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    @if ($isReviewable)
                                        <input type="hidden" name="{{ $item['name'] }}" value="0" form="verification-form">
                                        <label class="inline-flex items-center gap-2 text-xs font-bold text-emerald-800">
                                            <input
                                                ...
                                                @checked(old($item['name'], $item['checked']))
