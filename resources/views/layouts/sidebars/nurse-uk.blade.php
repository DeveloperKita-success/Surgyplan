<nav class="space-y-2">
    <p class="px-3 text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">Menu Perawat UK</p>

    <a href="{{ route('dashboard.nurse.uk') }}" class="flex items-center gap-3 rounded-lg bg-cyan-50 px-3 py-3 text-sm font-semibold text-cyan-800">
    ...
    @foreach ([
        ...
        ['label' => 'Kamar Operasi', 'icon' => 'room'],
        ['label' => 'Dokter', 'icon' => 'doctor'],
