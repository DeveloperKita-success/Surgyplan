<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-wrap justify-end gap-3">
            <a href="{{ route('patients.index') }}" class="rounded-lg border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50">Kembali</a>
            @if ($canManagePatients)
                <a href="{{ route('patients.edit', $patient) }}" class="rounded-lg bg-cyan-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-cyan-800">Edit Patient</a>
                <a href="{{ route('nurse.regular.room-operation.create') }}" class="rounded-lg border border-cyan-200 px-4 py-2.5 text-sm font-semibold text-cyan-700 hover:bg-cyan-50">Ajukan Operasi</a>
            @endif
        </div>
